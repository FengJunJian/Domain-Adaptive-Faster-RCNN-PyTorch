...
def parse_args():
    ...
    parser.add_argument(
        '--dataset', help="sim10k", default='sim10k', type=str)
    parser.add_argument(
        '--outdir', help="output dir for json files", default='VOC2012/sim10k_outdir', type=str)
    parser.add_argument(
        '--datadir', help="data dir for annotations to be converted",
        default='VOC2012/Annotations', type=str)
    # if len(sys.argv) == 1:
    #     parser.print_help()
    #     sys.exit(1)
